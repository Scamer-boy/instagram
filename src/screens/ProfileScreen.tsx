...
// import EditProfileButton from "../components/Buttons/EditProfileBtn";
...
import { useProfile } from "../hooks/useProfile";
import EditProfileButton from "../components/Buttons/EditProfileBtn";
import PostGrid from "../components/profilepost/PostGrid"; // ✅ Corrected import
    ...
    <View style={styles.container}>
      ...
      <View style={{ flex: 1 }}>
        {loadingPosts ? (
          ...
          //<PostGrid posts={posts} /> // ✅ Use PostGrid instead of FlatList
          <PostGrid posts={posts} /> // ✅ Pass posts correctly
        )}
      </View>
    </View>
  );
